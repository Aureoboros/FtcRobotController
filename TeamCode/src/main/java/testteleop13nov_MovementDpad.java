...
@TeleOp
public class testteleop13nov_MovementDpad extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            boolean gamepad1MoveActive = currentGamepad1.dpad_up || currentGamepad1.dpad_down ||
...
//            rotX = rotX * 1.1;  // Strafe correction
            ...
            //    if (intakeForwardActive) intakeReverseActive = false;
                // B changed to quick spin of ramp motor
            ...
            //    if (intakeReverseActive) intakeForwardActive = false;
                ...
                //Press Y Again here to enter pickup mode
            }

            //Moving the intake toggle forward to gamepad2 dpad up
            //Moving the intake toggle reverse to gamepad2 dpad down
