...
@Autonomous(name="Auto: 2 Spike Marks", group="Autonomous")
public class AutoTwoSpikeMarks extends LinearOpMode {
    ...
    // Red alliance spike marks (left side of field, in the corner area)
    private static final double RED_MIDDLE_SPIKE_X = -3.0;  // Middle spike mark
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // 11. Park near human player station
